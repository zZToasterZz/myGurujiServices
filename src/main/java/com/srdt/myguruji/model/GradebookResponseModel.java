...
public class GradebookResponseModel {
    ...
    public GradebookResponseModel(long gradbookid, String batchid, String courseid, String pslamtype, String assid, String asstype, double marks, String emplid) {
    ...
    public GradebookResponseModel(long gradbookid, String batchid, String courseid, String pslamtype, String assid, String asstype, double marks, String emplid, String freezestatus) {
        this.gradbookid = gradbookid;
        this.batchid = batchid;
        this.courseid = courseid;
        this.pslamtype = pslamtype;
