...
public class Topic {
	...
	public Topic(long topicid, long courseid, long batchid, String topictitle, String topicdescr, String createdby,
			String sysunitid, long outcomeid, String isactive) {
		super();
