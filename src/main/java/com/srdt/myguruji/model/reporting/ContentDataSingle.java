...
public class ContentDataSingle {
	...
	public ContentDataSingle() {
		super();
	}

	public ContentDataSingle(String faculty_code, String full_name, String crse_descr, String crse_title,
