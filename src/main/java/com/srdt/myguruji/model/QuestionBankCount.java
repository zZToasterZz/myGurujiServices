...
public class QuestionBankCount {
	...
	public QuestionBankCount() {
		super();
	}

	public QuestionBankCount(String coursecode, String questiontype, String topicdescr, long count) {
		super();
	...
	public QuestionBankCount(long courseid, long topicid, long typeid, String coursecode, String questiontype,
			String topicdescr, long count) {
		super();
