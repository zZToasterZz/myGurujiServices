...
public class AddedQuestion {
	...
	AssignmentResponseModel assignresponse;
	...
	public AddedQuestion(long sectionid, long questionid, long assessmentquestionid, BigDecimal marks,
			...
			String quesresponce, String correctresponse, String blmtaxonomy, String difficulty) {
		super();
	...
	public AssignmentResponseModel getAssignresponse() {
		return assignresponse;
	}

	public void setAssignresponse(AssignmentResponseModel assignresponse) {
